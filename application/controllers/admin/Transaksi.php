...
{
    private $pathView = 'role/admin/transaksi/';
    ...
    public function pinjam()
    {
        ...
        $this->load->view($this->pathView . 'pinjam_view', [
            'menuActive' => 'pinjam',
            'isEdit'     => FALSE,
            'url'        => site_url('admin/transaksi/pinjam_store'),
            'desa'       => $desa,
            'jenisHak'   => $jenisHak,
            'keperluan'  => $keperluan,
            'user'       => $user,
    ...
    public function pinjam_ubah($id_transaksi)
    {
        ...
        $this->load->view($this->pathView . 'pinjam_view', [
            'menuActive' => 'pinjam',
            'isEdit'     => TRUE,
            'url'        => site_url('admin/transaksi/pinjam_store/' . $id_transaksi),
            'desa'       => $desa,
            'jenisHak'   => $jenisHak,
            'keperluan'  => $keperluan,
            'transaksi'  => $transaksi,
    ...
    public function pinjam_store($id_transaksi = null)
    {
        ...
        if ($id_transaksi == null) {
            ...
            //     redirect(site_url('admin/transaksi/pinjam'));
            // }
        } else {
